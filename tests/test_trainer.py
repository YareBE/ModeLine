...
def test_inputs_validation_invalid_training_size(
        invalid_training_size, small_dataset_mock):
...
def test_inputs_validation_proper_cases(
...
def test_dataset_split_invalid_seed_type(
        small_dataset_mock, invalid_seed_types):
...
def test_dataset_split_invalid_seed_values(
        small_dataset_mock, invalid_seed_values):
...
def test_dataset_split_full_train_case(small_dataset_mock, proper_seed):
    ...
    final_X, null_X, final_y, null_y = trainer.split_dataset(
        X, y, 1.0, proper_seed)
...
def test_train_linear_regression_success(big_dataset_mock):
    ...
    assert hasattr(
        model, 'intercept_'), "The model should have 'intercept_' attribute"
